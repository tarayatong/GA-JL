...
from nets.yolov3_training import (YOLOLoss, get_lr_scheduler, set_optimizer_lr,
                                        weights_init)
from utils.callbacks import EvalCallback, LossHistory  # epoch_map
...
if __name__ == "__main__":
    ...
    # ---------------------------------------------------------------------#
    anchors_path    = 'model_data/yolo_anchors_small.txt'  #'model_data/yolo_anchors_small_twoMap.txt'
    anchors_mask    = [[6, 7, 8], [3, 4, 5], [0, 1, 2]]
    # anchors_path = 'model_data/yolo_anchors_small_twoMap.txt'
    ...
    # ------------------------------------------------------------------#
    Init_Epoch = 0
    Freeze_Epoch = 80  # 80  10  60
    Freeze_batch_size = 20  # 20
    # ------------------------------------------------------------------#
    #   解冻阶段训练参数
    ...
    # ------------------------------------------------------------------#
    iou_type = 'ciou_NWD_1'  # 'ciou_NWD_1'  'ciou'
    # ------------------------------------------------------------------#
    ...
    # ------------------------------------------------------------------#
    save_dir = 'logs/yolov3_SIRST'
    # ------------------------------------------------------#
    #   train_annotation_path   训练图片路径和标签
    #   val_annotation_path     验证图片路径和标签
    # ------------------------------------------------------#
    # train_annotation_path = '/home/liujing/Code/data/SAITD/SAITD/txt_train_test/126_129/train_lj.txt'
    # val_annotation_path = '/home/liujing/Code/data/SAITD/SAITD/txt_train_test/126_129/126_test_lj.txt'
    # train_annotation_path = r'/home/liujing/Code/data/IRSTD-ISNet/trainval_lj.txt'
    # val_annotation_path = r'/home/liujing/Code/data/IRSTD-ISNet/test_lj.txt'
    train_annotation_path = r'/home/liujing/Code/data/SIRST_lj/train_lj.txt'
    val_annotation_path = r'/home/liujing/Code/data/SIRST_lj/val_lj.txt'
    # train_annotation_path = r'/home/liujing/Code/data/IRSTD-ISNet/noise/blur/IRSTD-ISNet/trainval_lj.txt'
    # val_annotation_path = '/home/liujing/Code/data/IRSTD-ISNet/noise/blur/IRSTD-ISNet/test_lj.txt'
    # ------------------------------------------------------------------#
    ...
    if True:
        ...
        gen = DataLoader(train_dataset, shuffle=shuffle, batch_size=batch_size, num_workers=num_workers,
                         pin_memory=True,
                         drop_last=True, collate_fn=yolo_dataset_collate, sampler=train_sampler)  # shuffle = shuffle,
