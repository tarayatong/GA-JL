...
from nets.yolov3_GA import YoloBody
from nets.yolo_JL_Loss_training import (YOLOLoss, get_lr_scheduler, set_optimizer_lr,
                                weights_init)
...
if __name__ == "__main__":
    ...
    #------------------------------------------------------------------#
    save_dir            = 'logs/yolov3_twoMap_qian_coorAttn_max_SE_Iou_NWD_1/113_139'
    # ------------------------------------------------------#
    #   train_annotation_path   训练图片路径和标签
    #   val_annotation_path     验证图片路径和标签
    # ------------------------------------------------------#
    train_annotation_path = '/home/liujing/Code/data/SAITD/SAITD/txt_train_test/113_139/train_lj.txt'
    val_annotation_path = '/home/liujing/Code/data/SAITD/SAITD/txt_train_test/113_139/test_lj.txt'
